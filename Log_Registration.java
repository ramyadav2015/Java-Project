...
class Gvalue
{
    void getv()
    {
        JFrame fr = new JFrame("Loggning from");
        fr.setSize(350,400);
        ...
        JButton ob1 = new JButton("Longging");
    ...
    void registration()
    {
        JFrame fr = new JFrame("Registration from");
        fr.setSize(350,400);
        ...
        JButton ob2 = new JButton("User Logging");
